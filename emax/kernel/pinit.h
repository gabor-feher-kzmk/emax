/* *   		     proc1.h includes the header for proc1		  *
   *   -- By Kozmik (C) --                                     _____      *
...
LONG(0x00000003); // this is the num off the signal to handle
LONG(0x00000000); // if it's set the signal need to be masked
LONG(0x00000012); // the PID of the thread that handles the proc 

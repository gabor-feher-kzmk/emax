/* *   	          kbd.h includes the header for the keyboard drv	  *
   *   -- By Kozmik (C) --                                     _____      *
...
LONG(0x00000001); // this is the num off the signal to handle
LONG(0x00000000); // if it's set the signal need to be masked
LONG(0x0000000F); // the PID of the thread that handles the proc 
